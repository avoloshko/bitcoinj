...
public class BitcoinURITest {
    ...
    private static final String MAINNET_GOOD_ADDRESS = "LaWmcpiim3gEbqmnTdVXDiLou5X9dr391z";
    ...
    public void testGood_Combinations() throws BitcoinURIParseException {
        ...
        assertEquals(
                "BitcoinURI['amount'='654321000000000','label'='Hello World','message'='Be well','address'='LaWmcpiim3gEbqmnTdVXDiLou5X9dr391z']",
                testObject.toString());
    }
    ...
    public void testUnknown() throws BitcoinURIParseException {
        ...
        testObject = new BitcoinURI(MAINNET, BITCOIN_SCHEME + ":" + MAINNET_GOOD_ADDRESS
                + "?aardvark=true");
        assertEquals("BitcoinURI['aardvark'='true','address'='LaWmcpiim3gEbqmnTdVXDiLou5X9dr391z']", testObject.toString());
    ...
    public void brokenURIs() throws BitcoinURIParseException {
        ...
        String str = "litecoin://LaWmcpiim3gEbqmnTdVXDiLou5X9dr391z?amount=0.01000000";
        BitcoinURI uri = new BitcoinURI(str);
        assertEquals("LaWmcpiim3gEbqmnTdVXDiLou5X9dr391z", uri.getAddress().toString());
