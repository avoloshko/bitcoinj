 ...
 * Coin all = f.parseObject("MŁ 21");             <strong>// All the money in the world</strong>
 * </pre></blockquote>
 *
 ...
 * locale, a value of one bitcoin might be formatted as <pre>Ł1.00</pre> where a value
 * exceeding that by one satoshi would be <pre>µŁ1,000,000.01</pre>
 *
 ...
 * three places, that is, to <code>1000.0 mLTC</code>.
 *
 * <h3>Construction</h3>
 *
 ...
 * String mil = s.format(value);              <strong>// "₥Ł123.40"</strong>
 * String mic = s.format(value.divide(1000)); <strong>// "µŁ123.40"</strong>
 * </blockquote>
 *
 ...
 * <strong>// Next line returns "1,00 Ł"</strong>
 ...
 * <strong>// variable symbolic will be set to "kŁ1.23"</strong>
 ...
 * specified by <code>µŁ</code>, <code>uŁ</code>, <code>µB⃦</code>, <code>µɃ</code>,
...
public abstract class BtcFormat extends Format {
    ...
    private static final String COIN_SYMBOL = "Ł";
     ...
     * symbol, for example, <code>"Ł"</code>.  Formatting and parsing will be done
     ...
     * <code>"Ł"</code>.  The returned object will format the fraction-part of numbers using
     ...
     * select denominational units based on each value being formatted, and will indicate those
     * units using a currency symbol, for example, <code>"µŁ"</code>.
     */
     ...
     * <code>"µŁ"</code>.  The returned object will format the fraction-part of numbers using
     * the given number of decimal places, or fewer as necessary to avoid giving a place to
     * fractional satoshis.
     */
     ...
     * <code>"Ł"</code>, or code, such as <code>"mBTC"</code>, depending on the value of
     ...
     * using either a currency symbol, such as, <code>"Ł"</code>, or code, such as
     ...
     * "<code>BTC</code>", or symbol, such as "<code>Ł</code>", depending on the value
     ...
     * such as <code>"mBTC"</code>, or symbol, such as "<code>Ł</code>",
