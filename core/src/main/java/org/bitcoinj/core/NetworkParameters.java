...
public abstract class NetworkParameters {
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            final String message = "NY Times 05/Oct/2011 Steve Jobs, Apple’s Visionary, Dies at 56";

            ByteArrayOutputStream scriptSigBytes = new ByteArrayOutputStream();
            Script.writeBytes(scriptSigBytes, Hex.decode("ffff001d"));
            Script.writeBytes(scriptSigBytes, Hex.decode("04"));
            Script.writeBytes(scriptSigBytes, message.getBytes());

            t.addInput(new TransactionInput(n, t, scriptSigBytes.toByteArray()/* Hex.decode("04ffff001d0104404e592054696d65732030352f4f63742f32303131205374657665204a6f62732c204170706c65e280997320566973696f6e6172792c2044696573206174203536 ")*/));
